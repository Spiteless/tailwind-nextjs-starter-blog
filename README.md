...
- [Trillium's Blog](https://trilliumsmith.com/) - Modified to render resume pdf on `/resume` page. ([source code](https://github.com/trillium/trilliumsmith.com))technology. ([source code](https://github.com/frank-mendez/frank-blog))
